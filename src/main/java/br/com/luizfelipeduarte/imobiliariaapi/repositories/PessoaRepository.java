...
public interface PessoaRepository extends JpaRepository<Pessoa,Long>{
	...
	public Optional<Pessoa> findByAtivoAndTipoPessoaAndTipoPessoa(Boolean ativo,TipoPessoa tipo1, TipoPessoa tipo2);
	public Page<Pessoa> findByAtivoAndTipoPessoaOrTipoPessoa(Boolean ativo,TipoPessoa tipo,TipoPessoa tipo2,Pageable paginacao);
	...
	public Page<Pessoa> findByAtivoAndNomeContainingAndTipoPessoaOrTipoPessoa(Boolean ativo,String nome,TipoPessoa tipo,TipoPessoa tipo2,Pageable pg);
